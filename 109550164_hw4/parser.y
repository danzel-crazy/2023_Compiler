...
%type <declar> declarations
%type <subdeclar> subprogram_declarations
%type <compoundstatement> compound_statement
%type <type> type
%type <standtypenode> standard_type
%type <nextnode> subprogram_declaration
%type <subheadnode> subprogram_head
%type <arguments> arguments
%type <parameterlist> parameter_list
%type <optionalvarnode> optinal_var
%type <optionalstatementsnode> optinal_statements
...
%type <numnode> num
%type <node> prog  
%type <text> SCIENTIFIC LITERALSTR LPAREN RPAREN SEMICOLON DOT COMMA COLON LBRACE RBRACE DOTDOT ASSIGNMENT ADDOP SUBOP MULOP DIVOP LTOP GTOP EQOP GETOP LETOP NEQOP IDENTIFIER
%type <val> INTEGERNUM
